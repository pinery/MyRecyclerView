...
public class RecyclerViewGridAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewGridAdapter(Context context, List<String> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = inflater.inflate(R.layout.recycler_view_grid_item_layout, parent, false);
